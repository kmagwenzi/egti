...
# Value: jdbc:postgresql://dpg-d61qhsm3jp1c738goa00-a.oregon-postgres.render.com:5432/egti
DATABASE_URL=jdbc:postgresql://dpg-d61qhsm3jp1c738goa00-a.oregon-postgres.render.com:5432/egti

# Variable: DB_USERNAME
# Value: egti_user
DB_USERNAME=egti_user

# Variable: DB_PASSWORD
# Value: PidDRn1YyFNI3Q9RSteIpe5GAiu3uVtz
DB_PASSWORD=PidDRn1YyFNI3Q9RSteIpe5GAiu3uVtz
...
| Key | Value | Notes |
|-----|-------|-------|
| `DATABASE_URL` | `jdbc:postgresql://dpg-d61qhsm3jp1c738goa00-a.oregon-postgres.render.com:5432/egti` | ✅ Existing database |
| `DB_USERNAME` | `egti_user` | ✅ Current username |
| `DB_PASSWORD` | `PidDRn1YyFNI3Q9RSteIpe5GAiu3uVtz` | ✅ Current password |
...
```properties
# BEFORE (INSECURE):
spring.datasource.url=jdbc:postgresql://dpg-d61qhsm3jp1c738goa00-a.oregon-postgres.render.com:5432/egti
spring.datasource.username=egti_user
spring.datasource.password=PidDRn1YyFNI3Q9RSteIpe5GAiu3uVtz
...
"egti_user" → Should NOT appear in logs
